...
The primary physical build document is [modelo lego_11_07_58_copy-1.pdf](modelo%20lego_11_07_58_copy-1.pdf). Inspection confirms that it contains 82 numbered, illustrated LEGO assembly steps and finishes with the complete EV3 vehicle. [Los Grises Jr.pdf](Los%20Grises%20Jr.pdf) contains a separate 66-step illustrated LEGO model/subassembly sequence. Supporting files include the [port and component list](mechanic/List%20of%20ports%20and%20components.md) and printable [double ultrasonic mount](mechanic/PORTA%20ULTRA%20DOBLE%20%281%29.stl).
...
The physical robot can be followed through the numbered LEGO assembly sequence in the repository. This is the first file to open when reproducing the chassis:

**Robot build/model:** [Open the 82-step robot assembly PDF](modelo%20lego_11_07_58_copy-1.pdf)

The PDF uses a parts box and an assembly view on each numbered page and ends with the complete four-wheel EV3 vehicle. [Los Grises Jr.pdf](Los%20Grises%20Jr.pdf) provides an additional 66-step illustrated model/subassembly sequence. Use the [ports and components document](mechanic/List%20of%20ports%20and%20components.md) for the current electrical placement and sensor pin map, and the [double ultrasonic mount STL](mechanic/PORTA%20ULTRA%20DOBLE%20%281%29.stl) for the printable sensor support.
...
The [Engineering Journal](docs/Engineering%20Journal.md) records the progression from early ultrasonic control and I2C, through EV3-G, to current ev3dev and USB serial. The three Nano sketches preserve protocol history. This local copy has no usable Git metadata, so history should be read from the journal and source comments rather than inferred commit dates.
...
|:---:|:---:|
| <img src="https://github.com/user-attachments/assets/dd9e997b-65a7-4909-8207-ea3630b5aff4" width="280" alt="Renato Medina"> | <!-- TEAM PHOTO: PAULINA - add repository image here --> *Photograph to be added* |
| **Age:** 14 | **Age:** 22 |
